...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "Sistem Peringatan Dini Banjir adalah aplikasi berbasis web yang dirancang untuk membantu monitoring dan penyampaian informasi kondisi banjir secara cepat dan efisien. ",
    tags: ["Next.js, React, Supabase, Tailwind CSS, Vercel"],
    demo: "https://sistem-peringtan-dini-banjir.vercel.app/",
    github: "https://github.com/hitam12-aw/Sistem-peringtan-dini-banjir",
    icon: "💎",
  },
  {
   type: "Profile",
  title: "Explore More on GitHub",
  desc: "Click here to see more repositories, experiments, and ongoing projects available on my GitHub profile.",
  tags: ["GitHub", "Open Source", "More Projects"],
  github: "https://github.com/hitam12-aw",
  icon: "⚙️",
  },
];
